...
const AuthForm = () => {
  ...
  const onSubmitHandler=(e)=>{
    ...
    let url;
    if(isLogin){
      url= 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDFUhVsBRm5OtimsKO-HwtuMduXPEcyPzk';
    }
      else{
        url= 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDFUhVsBRm5OtimsKO-HwtuMduXPEcyPzk';
      }
      fetch(url ,{
        method:'POST',
        body: JSON.stringify({
