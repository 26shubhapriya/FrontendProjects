...
export default function Login() {
  ...
  const submitHandler = (e) => {
    ...
    // check mail
    const apiKey = "84970fd39c294e7796a2b25c9c1b7228";
    const apiURL =
    ...
    setIsLoading(true);
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBMVblYc-kgZPBCYozHEju1An9kxNT_kdM",
      {
        method: "POST",
        body: JSON.stringify({
          email: enteredEmail,
