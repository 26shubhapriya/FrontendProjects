...
const Expenses = () => {
  ...
  const [premiumActive, setPremiumActive] = useState( localStorage.getItem("premiumActivated"));
  ...
  const handleSubmit = (e) => {
    ...
    if (isEdit === true) {
      ...
      fetch(
        `https://expense-tracker-1-f6a97-default-rtdb.firebaseio.com/userExpenses${userEmail}/${expenseId}.json`,
        {
          method: "PUT",
      ...
      fetch(
        `https://expense-tracker-1-f6a97-default-rtdb.firebaseio.com/userExpenses${userEmail}.json`,
        {
          method: "POST",
          body: JSON.stringify(expenseData),
          headers: {
  ...
  const deleteHandler = (id) => {
    fetch(
      `https://expense-tracker-1-f6a97-default-rtdb.firebaseio.com/userExpenses${userEmail}/${id}.json`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
